...
package baidu.mapapi.clusterutil.clustering.view;
...
import baidu.mapapi.clusterutil.MarkerManager;
...
import baidu.mapapi.clusterutil.projection.SphericalMercatorProjection;
import baidu.mapapi.clusterutil.ui.IconGenerator;
...
import static baidu.mapapi.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        baidu.mapapi.clusterutil.clustering.view.ClusterRenderer<T> {

    private final String TAG = "DefClusterRender_TAG";
    ...
    private Drawable mColoredCircleBackground;
...
//        mIconGenerator.setBackground(context.getResources().getDrawable(R.mipmap.cluster05));
        mClusterManager = clusterManager;

        Resources resources = context.getResources();
        drawables = new Drawable[]{resources.getDrawable(R.mipmap.cluster01), resources.getDrawable(R.mipmap.cluster05)};
    }
    ...
    private LayerDrawable makeClusterBackground() {
        ...
        outline.getPaint().setColor(0x99ffffff); // Transparent white.
    ...
    private baidu.mapapi.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        baidu.mapapi.clusterutil.ui.SquareTextView squareTextView =
                new baidu.mapapi.clusterutil.ui.SquareTextView(context);
        ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        squareTextView.setLayoutParams(layoutParams);
        squareTextView.setId(R.id.text);
        int twelveDpi = (int) (8 * mDensity);
    ...
    protected void onBeforeClusterRendered(Cluster<T> cluster, MarkerOptions markerOptions) {
        ...
        int size = cluster.getSize();
        if (size < 5) {
            mIconGenerator.setBackground(drawables[0]);
        }else {
            mIconGenerator.setBackground(drawables[1]);
        }
