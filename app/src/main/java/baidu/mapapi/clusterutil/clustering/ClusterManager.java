...
package baidu.mapapi.clusterutil.clustering;
...
import baidu.mapapi.clusterutil.clustering.algo.Algorithm;
import baidu.mapapi.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import baidu.mapapi.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import baidu.mapapi.clusterutil.clustering.view.ClusterRenderer;
import baidu.mapapi.clusterutil.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void onMapStatusChangeStart(MapStatus mapStatus) {
        if(onMapStatusListener!=null){
            onMapStatusListener.onMapStatusChangeStart(mapStatus);
        }
    }
    ...
    public void onMapStatusChange(MapStatus mapStatus) {
        if(onMapStatusListener!=null){
            onMapStatusListener.onMapStatusChange(mapStatus);
        }
    ...
    public void onMapStatusChangeFinish(MapStatus mapStatus) {
        if(onMapStatusListener!=null){
            onMapStatusListener.onMapStatusChangeFinish(mapStatus);
        }
    }
    ...
    public void setOnMapStatusListener(OnMapStatusListener onMapStatusListener) {
